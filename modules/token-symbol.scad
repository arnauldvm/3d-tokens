...
module token_with_symbol(symbol, adjust_height_mm=0, font="Arial Unicode MS", symbol_thickness_mm=0.3, size=14, diameter_mm=30, thickness_mm=3, ridge_width_mm=2, ridge_depth_mm=0.5) {
